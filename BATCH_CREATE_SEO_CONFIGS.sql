...
INSERT INTO dynamic_page_seo (
  ...
  'Create stunning AI-generated videos of futuristic coastal cities at sunset using our text-to-video AI generator. As a Sora alternative, we transform your text prompts into professional-quality videos with neon lights, flying vehicles, and cinematic effects.',
  'Generate Video: A sweeping aerial shot over a futuristic coastal city',
  'This page is dedicated to generating AI videos based on the prompt: "A sweeping aerial shot over a futuristic coastal city at sunset, glass skyscrapers with neon lights, flying vehicles leaving light trails, camera gliding through the skyline with lens flares, ultra realistic, shot on 8k cinema camera." Our platform is a leading Sora alternative that uses advanced text-to-video AI technology to create high-quality, professional videos from text descriptions. Each video is generated with attention to detail, ensuring cinematic quality and visual appeal. The futuristic cityscape with neon lights and flying vehicles creates a stunning visual experience that captures the imagination. Whether you are creating marketing content, social media videos, or creative projects, our AI video generation platform makes it easy to bring your ideas to life. As a top Sora alternative, we offer features comparable to OpenAI Sora at competitive prices. The video generation process is simple: enter your detailed text description, select your preferred aspect ratio and duration, and let our AI do the rest. All videos are generated in high quality and can be downloaded immediately after completion. This specific prompt creates a breathtaking aerial view of a futuristic metropolis, combining elements of science fiction with realistic cinematography techniques. The 8k cinema camera quality ensures every detail is captured with precision, from the glass skyscrapers reflecting the sunset to the neon lights illuminating the city streets below.',
  ARRAY['text to video ai', 'sora alternative', 'ai video generator', 'futuristic city', 'aerial shot', 'neon lights', 'flying vehicles', 'cinematic', 'ai video like sora'],
  TRUE,
  10
...
INSERT INTO dynamic_page_seo (
  ...
  'Create adorable AI-generated videos of red pandas in a magical glowing forest using our text-to-video AI generator. As a Sora alternative, we offer Pixar-style animation with soft lighting and whimsical atmosphere.',
  'Generate Video: Close-up of two curious red pandas exploring a glowing forest',
  'This page is dedicated to generating AI videos featuring red pandas in a magical forest setting. The prompt describes a close-up view of two curious red pandas exploring a glowing forest environment, with soft volumetric light beams creating an ethereal atmosphere. Dust particles float gently in the air, adding depth and magic to the scene. The shallow depth of field creates a cinematic focus on the pandas, while the whimsical mood and Pixar style ensure a charming and family-friendly result. Our platform is a leading Sora alternative that uses advanced text-to-video AI technology to bring this enchanting scene to life, creating high-quality videos that capture the playful nature of red pandas in a fantastical setting. Whether you are creating content for children, nature documentaries, or creative projects, this video generation option provides a unique and captivating visual experience. The Pixar-style animation brings a sense of warmth and wonder to the video, making it perfect for educational content, social media posts, or marketing materials that aim to evoke positive emotions and connection with nature. As a top Sora alternative, we offer competitive features and pricing that make AI video generation accessible to everyone.',
  ARRAY['text to video ai', 'sora alternative', 'ai video generator', 'red pandas', 'glowing forest', 'Pixar style', 'whimsical', 'nature', 'wildlife', 'ai video like sora'],
  TRUE,
  10
) ON CONFLICT (page_url) DO UPDATE SET
  title = EXCLUDED.title,
...
INSERT INTO dynamic_page_seo (
  ...
  'Create professional AI-generated fashion videos with bold neon lighting and avant-garde styling using our text-to-video AI generator. As a Sora alternative, perfect for fashion brands and editorial content.',
  'Generate Video: Editorial fashion walk on a reflective runway',
  'This page is dedicated to generating AI videos for fashion and editorial content. The prompt describes an editorial fashion walk on a reflective runway, featuring bold neon purple and teal lighting that creates a dramatic and modern atmosphere. The model wears an avant-garde metallic outfit that catches and reflects the vibrant lighting, creating stunning visual effects. The camera moves backward with subtle parallax, adding depth and movement to the scene. The crisp reflections on the glossy floor create a mirror-like effect that doubles the visual impact of the fashion presentation. Our platform is a leading Sora alternative that uses advanced text-to-video AI technology to create high-quality fashion videos that rival professional production quality. Whether you are creating content for fashion brands, editorial magazines, social media campaigns, or marketing materials, this video generation option provides a sophisticated and visually striking result. The combination of bold colors, avant-garde styling, and professional cinematography makes this perfect for brands looking to stand out in the competitive fashion industry. As a top Sora alternative, we offer competitive features and pricing that make professional video generation accessible to fashion creators.',
  ARRAY['text to video ai', 'sora alternative', 'ai video generator', 'fashion', 'editorial', 'runway', 'neon lighting', 'avant-garde', 'ai video like sora'],
  TRUE,
  10
) ON CONFLICT (page_url) DO UPDATE SET
  title = EXCLUDED.title,
...
INSERT INTO dynamic_page_seo (
  ...
  'Create dynamic AI-generated sports videos with slow-motion effects using our text-to-video AI generator. As a Sora alternative, perfect for sports content, highlights, and athletic brand marketing.',
  'Generate Video: Slow-motion shot of a basketball player leaping for a dunk',
  'This page is dedicated to generating AI videos for sports and athletic content. The prompt describes a slow-motion shot of a basketball player leaping for a dunk during a street game, capturing the intensity and athleticism of the moment. Sweat particles are visible in the air, adding realism and physicality to the scene. Motion trails follow the player''s movement, creating a sense of speed and power. The dynamic crowd in the background adds atmosphere and context, showing the energy of a live street basketball game. The golden hour lighting creates warm, cinematic tones that enhance the dramatic nature of the athletic performance. The handheld documentary style adds authenticity and immediacy to the footage, making viewers feel like they are right there in the action. Our platform is a leading Sora alternative that uses advanced text-to-video AI technology to create high-quality sports videos that capture the excitement and intensity of athletic competition. Whether you are creating content for sports brands, athletic programs, social media highlights, or marketing campaigns, this video generation option provides dynamic and engaging visual content that resonates with sports enthusiasts and athletes alike. As a top Sora alternative, we offer competitive features and pricing that make professional sports video generation accessible to creators.',
  ARRAY['text to video ai', 'sora alternative', 'ai video generator', 'basketball', 'sports', 'slow-motion', 'athletic', 'street game', 'ai video like sora'],
  TRUE,
  10
) ON CONFLICT (page_url) DO UPDATE SET
  title = EXCLUDED.title,
...
INSERT INTO dynamic_page_seo (
  ...
  '/video',
  NULL,
  'Text to Video AI Generator - Best Sora Alternative',
  'Create professional AI videos from text with our free text-to-video AI generator. As a leading Sora alternative, we offer high-quality video generation comparable to OpenAI Sora. Start creating videos with 30 free credits.',
  'Text to Video AI Generator - Best Sora Alternative',
  'Welcome to our text-to-video AI generator, one of the best Sora alternatives available today. This page allows you to create stunning, professional-quality videos from simple text descriptions, just like OpenAI Sora. Our AI video generator makes it easy to bring your creative ideas to life, whether you are creating marketing content, social media videos, educational materials, or artistic projects. As a top Sora alternative, we offer competitive features and pricing that make AI video generation accessible to everyone. The video generation process is straightforward: simply enter a detailed text prompt describing the video you want to create, select your preferred aspect ratio (portrait 9:16 or landscape 16:9), choose the video duration (10 or 15 seconds), and let our advanced AI technology do the rest. Each video is generated with high quality and attention to detail, ensuring professional results suitable for any use case. Our platform supports various video styles including cinematic shots, documentary footage, fashion content, nature scenes, sports highlights, and abstract visuals. New users receive 30 free credits to get started, with no credit card required. Each video generation costs 10 credits, making it affordable for creators of all levels. When comparing Sora alternatives like Runway, Pika, Luma, and our platform, we stand out with our user-friendly interface, competitive pricing, and high-quality output. Start creating your AI-generated videos today and experience the power of text-to-video AI technology.',
  ARRAY['text to video ai', 'sora alternative', 'ai video generator', 'text to video', 'sora alternative free', 'ai video like sora', 'best sora alternative', 'openai sora alternative', 'free sora alternative'],
  TRUE,
  5
) ON CONFLICT (page_url) DO UPDATE SET
  title = EXCLUDED.title,
