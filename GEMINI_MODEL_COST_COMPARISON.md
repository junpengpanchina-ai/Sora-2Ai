...
|------|---------|---------|---------|-----------|------|---------|
| **gemini-2.5-flash** | ￥0.3~0.6 /M | ￥0.6~1.2 /M | ❌ 不支持 | 1,048,576 | ⚡ 最快 | 快速生成，成本敏感 |
| **gemini-3-flash** | ￥0.25~0.5 /M | ￥1.5~3 /M | ✅ **支持** | - | ⚡ 快 | 需要联网搜索，平衡成本 |
| **gemini-3-pro** | ￥1~2 /M | ￥6~12 /M | ✅ 支持 | - | 🐢 较慢 | 复杂任务，最高质量 |

## 💰 人民币成本对比（实际价格）

| 模型 | 输入成本 | 输出成本 | 联网搜索 | 总成本（输入+输出） | 成本倍数 |
|------|---------|---------|---------|------------------|---------|
| **gemini-2.5-flash** | ￥0.3~0.6 /M | ￥0.6~1.2 /M | ❌ | **￥0.9~1.8 /M** | 1x |
| **gemini-3-flash** | ￥0.25~0.5 /M | ￥1.5~3 /M | ✅ | **￥1.75~3.5 /M** | **2~2.5x** |
| **gemini-3-pro** | ￥1~2 /M | ￥6~12 /M | ✅ | **￥7~14 /M** | 8~15x |
...
|------|---------|---------|-----------|---------|
| **gemini-2.5-flash** | ￥0.06~0.12 | ￥0.9~1.8 | **￥0.96~1.92** | 1x |
| **gemini-3-flash** | ￥0.05~0.10 | ￥2.25~4.5 | **￥2.30~4.60** | **2.4~2.5x** |
| **gemini-3-pro** | ￥0.2~0.4 | ￥9~18 | **￥9.20~18.40** | 9.6~10x |

## 🎯 推荐选择

### 1. **gemini-2.5-flash**（当前默认）
- ✅ **最低成本**：￥0.96~1.92 / 10,000 条
- ✅ **最快速度**
...
- ✅ **支持联网搜索**：可获取最新行业趋势
- ✅ **成本适中**：￥2.30~4.60 / 10,000 条（约 **2.4~2.5倍**成本）
- ✅ **速度快**
- ✅ **输入成本更低**：￥0.25~0.5 /M（比 2.5-flash 更便宜）
- **适用**：需要最新行业信息的场景词生成

### 3. **gemini-3-pro**
- ✅ **最高质量**：更强的推理能力
- ✅ **支持联网搜索**
- ❌ **成本最高**：￥9.20~18.40 / 10,000 条（约 **10倍**成本）
- ❌ **速度较慢**
- **适用**：复杂任务，对质量要求极高
