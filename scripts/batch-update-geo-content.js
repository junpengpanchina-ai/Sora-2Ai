...
Add a 2-3 sentence paragraph about real limitations specific to ${useCase.industry || 'this industry'}:

Template:
"In the ${useCase.industry || 'this'} sector, AI-generated video may have limitations when [specific constraint 1], [specific constraint 2], or [specific constraint 3]. Teams should consider [consideration] before applying this approach to [specific scenario]."
...
- "When should AI video not be used in ${useCase.industry || 'this industry'}?"
- "What are common limitations of AI-generated video for ${useCase.title}?"
- "What scenarios are not suitable for AI-generated video in ${useCase.industry || 'this industry'}?"
