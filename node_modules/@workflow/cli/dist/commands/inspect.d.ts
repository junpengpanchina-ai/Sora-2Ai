...
export default class Inspect extends BaseCommand {
    ...
    static args: {
        readonly resource: import("@oclif/core/interfaces").Arg<string, Record<string, unknown>>;
        readonly id: import("@oclif/core/interfaces").Arg<string | undefined, Record<string, unknown>>;
    };
    static flags: {
        ...
        readonly cursor: import("@oclif/core/interfaces").OptionFlag<string, import("@oclif/core/interfaces").CustomOptions>;
        ...
        readonly workflowName: import("@oclif/core/interfaces").OptionFlag<string | undefined, import("@oclif/core/interfaces").CustomOptions>;
        readonly withData: import("@oclif/core/interfaces").BooleanFlag<boolean>;
    };
    run(): Promise<void>;
}
