...
export async function launchWebUI(resource, id, flags, _cliVersion) {
    ...
    if (!envVars.WORKFLOW_LOCAL_UI && isVercelBackend) {
        logger.info('If you do not want to use the Vercel dashboard, set WORKFLOW_LOCAL_UI=1 in your environment variables.');
    }
    if (isVercelBackend &&
        teamSlug &&
        projectName &&
 ...
 */
function envToQueryParams(resource, id, flags, envVars) {
