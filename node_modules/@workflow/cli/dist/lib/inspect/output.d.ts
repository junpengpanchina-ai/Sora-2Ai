...
export declare const showStream: (world: World, streamId: string, opts?: InspectCLIOptions) => Promise<void>;
/**
 * Listing streams only lists available stream IDs based on run/step passed,
 * and doesn't read any data from the streams.
 */
export declare const listStreamsByRunId: (world: World, opts?: InspectCLIOptions) => Promise<void>;
