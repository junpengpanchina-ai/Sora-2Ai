 ...
 */
export declare const setupPaginationListener: (state: PaginationState, callbacks: PaginationCallbacks) => (() => void);
/**
 * Show pagination state info
 */
export declare const showPaginationState: (state: PaginationState) => void;
/**
 ...
 */
export declare function setupListPagination<TData>(options: ListPaginationOptions<TData>): Promise<void>;
