import type { CreateEventParams, CreateEventRequest, Event, ListEventsByCorrelationIdParams, ListEventsParams } from './events.js';
import type { CreateHookRequest, GetHookParams, Hook, ListHooksParams } from './hooks.js';
import type { Queue } from './queue.js';
import type { CancelWorkflowRunParams, CreateWorkflowRunRequest, GetWorkflowRunParams, ListWorkflowRunsParams, PauseWorkflowRunParams, ResumeWorkflowRunParams, UpdateWorkflowRunRequest, WorkflowRun } from './runs.js';
import type { PaginatedResponse } from './shared.js';
import type { CreateStepRequest, GetStepParams, ListWorkflowRunStepsParams, Step, UpdateStepRequest } from './steps.js';
export interface Streamer {
    writeToStream(name: string, runId: string | Promise<string>, chunk: string | Uint8Array): Promise<void>;
