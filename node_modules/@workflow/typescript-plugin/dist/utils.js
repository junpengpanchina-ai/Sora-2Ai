...
exports.WORKFLOW_HOOKS = void 0;
exports.detectSimilarStrings = detectSimilarStrings;
exports.getDirective = getDirective;
exports.getDirectiveTypo = getDirectiveTypo;
exports.isAsyncFunction = isAsyncFunction;
exports.findFunctionCalls = findFunctionCalls;
/**
 * Helper to compare characters and advance indices
 */
function advanceIndices(i, j, aLen, bLen) {
    if (aLen > bLen) {
        return [i + 1, j];
    }
    if (bLen > aLen) {
 ...
 */
function detectSimilarStrings(a, b) {
 ...
 */
function getDirective(node, _sourceFile, ts) {
 ...
 */
function getDirectiveTypo(text) {
 ...
 */
function isAsyncFunction(node, typeChecker, ts) {
 ...
 */
function findFunctionCalls(node, _sourceFile, tsLib) {
    const calls = [];
    function visit(node) {
