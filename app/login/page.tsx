  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-indigo-900">
      ...
      <div className="relative z-10 w-full px-6">
        <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[430px_minmax(0,1fr)]">
          ...
          <div className="hidden lg:block">
            <div className="login-visual" aria-hidden="true">
              ...
              <div className="login-visual__panel">
                <p className="login-visual__panel-label">Sora Control</p>
                <p className="login-visual__panel-value">Secure gateway ready</p>
                <p className="login-visual__panel-hint">Google sign-in · Encrypted</p>
              </div>
            </div>
          </div>
        </div>
