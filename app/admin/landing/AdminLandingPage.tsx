...
export default function AdminLandingPage({ adminUser }: AdminLandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-energy-hero dark:bg-energy-hero-dark">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm text-gray-600 dark:text-gray-400">首页管理</span>
            </div>
            <div className="flex items-center gap-4">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <AdminHomepageManager onShowBanner={showBanner} />
      </main>
    </div>
  )
}
