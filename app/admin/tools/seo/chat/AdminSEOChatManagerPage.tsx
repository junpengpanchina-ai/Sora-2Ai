...
interface AdminSEOChatManagerPageProps {
  adminUser: { id: string; username: string; is_super_admin: boolean }
}

export default function AdminSEOChatManagerPage({ adminUser }: AdminSEOChatManagerPageProps) {
  ...
  return (
    <div className="min-h-screen bg-energy-hero dark:bg-energy-hero-dark">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm text-gray-600 dark:text-gray-400">SEO 聊天（研发工具）</span>
            </div>
            <div className="flex items-center gap-4">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <AdminSEOChatManager onShowBanner={showBanner} />
      </main>
    </div>
  )
}
