...
interface AdminChatDebugPageProps {
  adminUser: {
    id: string
    username: string
...
export default function AdminChatDebugPage({ adminUser }: AdminChatDebugPageProps) {
  ...
  return (
    <div className="min-h-screen bg-energy-hero dark:bg-energy-hero-dark">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm text-gray-600 dark:text-gray-400">聊天调试（研发工具）</span>
            </div>
            <div className="flex items-center gap-4">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <AdminChatDebug onShowBanner={showBanner} />
      </main>
    </div>
  )
}
