...
export default function PrivacyPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#050b18] text-white">
      ...
      <h1 className="mb-6 text-3xl font-semibold text-white">Sora2Ai Videos Privacy Policy</h1>
      <p className="mb-4">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-white">1. Information We Collect</h2>
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-white">2. Purpose of Processing</h2>
      <ul className="mb-4 list-disc space-y-2 pl-6">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-white">3. Sharing and Subprocessing</h2>
      <p className="mb-4">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-white">4. Data Storage and Security</h2>
      <ul className="mb-4 list-disc space-y-2 pl-6">
        <li>
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-white">5. Your Rights</h2>
      <ul className="mb-4 list-disc space-y-2 pl-6">
        <li>
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-white">6. Cross-Border Transfers</h2>
      <p className="mb-4">
      ...
      <h2 className="mt-8 mb-3 text-xl font-semibold text-white">7. Policy Updates</h2>
      <p className="mb-4">
